...
def exercise1a():
    ...
    def influence_of_k(k,parameters,time,x0,k_test):
        ...
        for i in range(0,2): 
            ...
            plt.legend(['k1=k2 = %s'%(k_test[0]) , 'k1=k2 = %s'%(k_test[1])])
#            plt.legend(['k = s'])
            plt.grid()
            plt.show()
        ''' the phase '''
    ...
    def influence_of_theta0(theta0,parameters,time,x0,theta0_test):
        ...
        plt.title('The change of the amplitude, the range of motion, and the period in function of theta0')
        ...
        for i in range(0,2): 
            ...
            plt.legend(['theta01=theta02 = %s'%(theta0_test[0]) , 'theta01=theta02 = %s'%(theta0_test[1])]) 
            plt.grid()
            plt.show()
        ''' the phase '''
        for theta0_ in theta0_test:
    ...
    def different_k1_k2(k1,k2,parameters,time,x0):
        ...
        plt.show()
        res.plot_phase("Phase")
        plt.title('Phase with k1 = %s, k2 = %s' %(k1,k2))
        plt.show()
        parameters. __init__()
        return None
    ...
    def different_theta01_theta02(theta01,theta02,parameters,time,x0):
        ...
        plt.show()
        res.plot_phase("Phase")
        plt.title('Phase with theta01 = %s, theta02 = %s' %(theta01,theta02))
        plt.show()
        parameters. __init__()
        return None
